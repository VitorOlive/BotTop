...
global.mods = ['559889016015@s.whatsapp.net']
global.prems = []

global.dfail = (type, m, conn) => {
  let msg = {
    owner: 'Este comando só pode ser usado pelo Vitinn!',
    mods: 'Este comando só pode ser usado por moderadores!',
    premium: 'Este comando é apenas para membros Premium!',
    group: 'Comando só pode ser usado em grupos!',
    private: 'Este comando só pode ser usado em Chats Privados!',
    admin: 'Este comando é apenas para administradores de grupo, seu membro comum fraco !',
    botAdmin: 'Faça do bot um administrador para usar este comando! '
  }[type]
